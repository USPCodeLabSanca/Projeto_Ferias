...
export default function Letra(props) {
    const { board, correct, tentativaAtual, acertou } = useContext(AppContext)
    ...
    const letraState = (tentativaAtual.tentativa > props.tentativa || acertou) && (correta ? "correta" : quase ? "quase" : "erro")
